...
export const hood = {
  ko: {
    ...
    blocks: [
      ...
      {
        h: '근대문화골목',
        p: '대구 중구의 골목투어 「근대로의 여행」 제2코스가 <strong>근대문화골목</strong>입니다. 2012년 한국 관광의 별로 뽑혔고 한국관광 100선에도 연이어 이름을 올린, 골목투어를 전국 콘텐츠로 만든 길입니다. 청라언덕의 선교사 주택에서 시작해 3·1만세운동길 계단을 내려와 계산성당과 이상화·서상돈 고택을 지나면, 길은 자연스럽게 약전골목으로 이어집니다. 코스 순서와 점심·주차는 <a href="daegu-modern-alley.html" data-track="blog" data-track-label="hood-alley">대구 근대골목 2코스 안내</a>에 정리했습니다.',
      },
      {
        h: '걷다가 한 그릇',
  ...
  en: {
    ...
    blocks: [
      ...
      },
      {
        ...
        p: 'The full walk takes two to three hours. Sitting down to a hot bowl at the halfway point makes the second half far easier. For something light, try the clear haejang-guk; for a fuller meal, the short rib soup.',
      },
    ],
    ...
    spots: {
      ...
      dongseong:{ n: 'Dongseong-ro', d: 'Downtown Daegu’s main shopping and nightlife street.' },
